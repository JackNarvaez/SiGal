...
void mwg1(double *Pos, double *Vel, double *Mass, int *i, const int Nl, const int N,const double R, const double M, const int I) {
    ...
    const int    N_H    = N_D/2;
    plummer_dist(Pos+3*(N_D+N_B), Vel+3*(N_D+N_B), Mass+N_D+N_B, i+N_D+N_B, N_H, N_H_T, R_H, M_H, I+2);
